...
Existen dos formas de arrancar la API dependiendo de tu ubicación en la terminal. **Es indispensable tener el entorno virtual activo.**
...
> **Nota:** Usamos `--app-dir` para que el servidor localice correctamente los módulos internos (`utils.py`, etc.) y el modelo entrenado.
...
Abre una nueva terminal y ejecuta el siguiente comando para probar una predicción rápida:
