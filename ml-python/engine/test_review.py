...
class SentimentLabG68:
    ...
    def analyze(self, text):
        ...
        prevision = "positivo" if total > 0.05 else "negativo" if total < -0.05 else "neutro"

        # COMENTA O ELIMINA LOS PRINTS PARA LIMPIAR EL BENCHMARK
        # print("-" * 75)
    ...
    def predict(self, text):
        # Esta es la puerta de entrada que usa tu test_models_benchmark.py
